...
---assume that the given position is either the start of a byte sequence or one
---plus the length of the subject string. As in the string library, negative indices
---count from the end of the string.
---
---[Open in browser](https://www.lua.org/manual/5.3/manual.html#6.5)
---
---@class utf8
utf8 = {}
...
---The pattern (a string, not a function) `"[\0-\x7F\xC2-\xF4][\x80-\xBF]*"`, which
---matches exactly one UTF-8 byte sequence, assuming that the subject is a valid
---UTF-8 string.
---
---@type string
...
---and c the code point of each character. It raises an error if it meets any invalid
---byte sequence.
---
---@param s string
...
---
---@param s string
---@param i integer? Default `1`
---@param j integer? Default `i`
---@return integer[]
...
---its end, the function returns nil.
---
